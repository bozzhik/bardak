...
function DialogFooter({
  ...
  return (
    <div data-slot="dialog-footer" className={cn('-mx-4 -mb-4 flex flex-row flex-wrap items-center justify-end gap-2 rounded-b-xl border-t bg-muted/50 p-4', 'sm:flex-col-reverse sm:items-stretch sm:gap-3', '[&_button]:w-auto sm:[&_button]:w-full', className)} {...props}>
      {children}
